...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/* Windows 8 app icon */}
      <meta name='msapplication-TileColor' content='#3848f5' />
      <meta
